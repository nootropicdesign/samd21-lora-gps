...
// Application EUI is provided by The Things Network when you create an application.
// Device EUI and Application Key are provided by The Things Network when you create an OTAA device.
// Take care to specify these in either least-significant-bit (LSB) or most-significant-bit (MSB)
// format, depending on which field.
